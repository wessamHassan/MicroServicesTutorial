...
{
    public class OrdersProvider : IOrdersProviders
    {
        ...
        public async Task<(bool IsSucc, IEnumerable<Models.Order> orders, string ErrorMsg)> GetOrdersAsync(int customerId)
        {
            try
            {
                var orders = await ordersDbContext.Orders.Where(o => o.CustomerId == customerId).Include(o => o.Items).ToListAsync();
